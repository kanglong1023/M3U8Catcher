...
import static io.github.kanglong1023.m3u8.util.AsciiFullWidthUtil.*;
import static io.github.kanglong1023.m3u8.util.Preconditions.checkNotEmpty;
import static io.github.kanglong1023.m3u8.util.Preconditions.checkNotNull;
import static io.github.kanglong1023.m3u8.util.TextTableFormat.Printer.*;
...
public final class TextTableFormat {
    ...
    public TextTableFormat setTitles(String... titles) {
        return setTitles(Arrays.asList(Preconditions.checkNotNull(titles)));
    }
    ...
    public TextTableFormat setTitles(List<String> titles) {
        ...
        this.titles = (List<String>) Preconditions.checkNotEmpty(titles);
        return this;
    }
    ...
    public TextTableFormat setData(List<List<String>> data) {
        this.data = (List<List<String>>) Preconditions.checkNotEmpty(data);
        return this;
    }

    public TextTableFormat addData(String... row) {
        return addData(Arrays.asList(Preconditions.checkNotNull(row)));
    }

    public TextTableFormat addData(List<String> row) {
        Preconditions.checkNotEmpty(row);
