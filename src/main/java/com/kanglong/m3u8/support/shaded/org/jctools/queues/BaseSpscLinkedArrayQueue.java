 ...
 */
package com.kanglong.m3u8.support.shaded.org.jctools.queues;

import com.kanglong.m3u8.support.shaded.org.jctools.queues.IndexedQueueSizeUtil.IndexedQueue;
import com.kanglong.m3u8.support.shaded.org.jctools.util.PortableJvmInfo;
import com.kanglong.m3u8.support.shaded.org.jctools.util.UnsafeAccess;

import java.util.AbstractQueue;
import java.util.Iterator;

import static com.kanglong.m3u8.support.shaded.org.jctools.util.UnsafeRefArrayAccess.*;
...
abstract class BaseSpscLinkedArrayQueueConsumerField<E> extends BaseSpscLinkedArrayQueueConsumerColdFields<E> {
    ...
    private final static long C_INDEX_OFFSET = UnsafeAccess.fieldOffset(BaseSpscLinkedArrayQueueConsumerField.class, "consumerIndex");
...
abstract class BaseSpscLinkedArrayQueueProducerFields<E> extends BaseSpscLinkedArrayQueueL2Pad<E> {
    ...
    private final static long P_INDEX_OFFSET = UnsafeAccess.fieldOffset(BaseSpscLinkedArrayQueueProducerFields.class, "producerIndex");
...
abstract class BaseSpscLinkedArrayQueue<E> extends BaseSpscLinkedArrayQueueProducerColdFields<E>
    ...
    protected final E[] lvNextArrayAndUnlink(E[] curr) {
        final long offset = LinkedArrayQueueUtil.nextArrayOffset(curr);
    ...
    private E newBufferPeek(final E[] buffer, final long index) {
        ...
        final long mask = LinkedArrayQueueUtil.length(nextBuffer) - 2;
        consumerMask = mask;
        final long offset = calcCircularRefElementOffset(index, mask);
