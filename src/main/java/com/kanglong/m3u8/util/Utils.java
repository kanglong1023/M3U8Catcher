...
import static com.kanglong.m3u8.util.Preconditions.m3u8Check;
...
public final class Utils {
    ...
    public static Path checkAndCreateDir(Path dir, String dirName) throws IOException {
        ...
        m3u8Check(Objects.nonNull(dir), "%s is null", dirName);
        if (Files.exists(dir)) {
            m3u8Check(Files.isDirectory(dir), "%s is not a directory: %s", dirName, dir);
        } else {
